...
class SpacyPredictor:
    ...
    def get_gender(self, profession: str, translated_sent = None, entity_index = None, ds_entry = None) -> GENDER:
        ...
        if self.lang == "pt" and \
            ds_entry[0] == "neutral" or "someone" in correct_prof \
            or "child" in correct_prof \
            or "witness" in correct_prof \
            or "victim" in correct_prof: 
            # neutral form is not common in Portuguese (only for words such as child)
